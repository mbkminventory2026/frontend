...
import { getDepartemenById, updateDepartemen } from '@/api/departemen/departemen';
...
const form = useForm({
    api: {
        get: () => getDepartemenById(id.value),
        update: (_id, payload) => {
            const { created_at, id_departemen, ...data } = payload;
            return updateDepartemen(id_departemen, data);
        }
    },
    id: id.value,
    immediate: true
                    ...
                    <Card class="overflow-hidden border-none shadow-md">
                        ...
                        <CardContent class="pt-6">
                            ...
                            <div v-else class="animate-in fade-in slide-in-from-top-4 duration-500">
                                <AppForm :form="form">
                                    <div class="space-y-4">
                                        <AppFormField name="nama_departemen" label="Nama Departemen" placeholder="Masukkan nama departemen" />
                                    </div>
