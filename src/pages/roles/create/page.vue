...
import { createRole } from '@/api/roles/roles';
...
<template>
    <div class="container mx-auto py-8 max-w-4xl space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-[13px] text-slate-500 mt-1">
                        Tentukan nama role dan atur hak akses yang diberikan.
                    </p>
                </div>
            </div>
        ...
        <!-- Loading State -->
        <div v-if="isLoadingPermissions" class="flex flex-col items-center justify-center min-h-[300px] gap-4">
            <Spinner class="size-8" />
            <p class="text-slate-500 animate-pulse text-sm">Memuat daftar hak akses...</p>
        </div>
        ...
        <div v-else class="space-y-6">
            ...
            <div class="border-t border-slate-200 pt-6 flex gap-3 justify-end">
                ...
                >
                    ...
                    <template v-else>
                        <SaveIcon class="w-4 h-4" /> Simpan Role
                    </template>
                </Button>
            </div>
        </div>
